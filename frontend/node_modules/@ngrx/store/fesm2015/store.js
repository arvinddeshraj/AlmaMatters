 ...
 */
const /** @type {?} */ INIT = /** @type {?} */ ('@ngrx/store/init');
...
const /** @type {?} */ ACTIONS_SUBJECT_PROVIDERS = [ActionsSubject];

/**
 * @fileoverview added by tsickle
 * @suppress {checkTypes} checked by tsc
 */
const /** @type {?} */ _INITIAL_STATE = new InjectionToken('@ngrx/store Internal Initial State');
const /** @type {?} */ INITIAL_STATE = new InjectionToken('@ngrx/store Initial State');
const /** @type {?} */ REDUCER_FACTORY = new InjectionToken('@ngrx/store Reducer Factory');
const /** @type {?} */ _REDUCER_FACTORY = new InjectionToken('@ngrx/store Reducer Factory Provider');
const /** @type {?} */ INITIAL_REDUCERS = new InjectionToken('@ngrx/store Initial Reducers');
const /** @type {?} */ _INITIAL_REDUCERS = new InjectionToken('@ngrx/store Internal Initial Reducers');
const /** @type {?} */ META_REDUCERS = new InjectionToken('@ngrx/store Meta Reducers');
const /** @type {?} */ STORE_FEATURES = new InjectionToken('@ngrx/store Store Features');
const /** @type {?} */ _STORE_REDUCERS = new InjectionToken('@ngrx/store Internal Store Reducers');
const /** @type {?} */ _FEATURE_REDUCERS = new InjectionToken('@ngrx/store Internal Feature Reducers');
const /** @type {?} */ _FEATURE_REDUCERS_TOKEN = new InjectionToken('@ngrx/store Internal Feature Reducers Token');
const /** @type {?} */ FEATURE_REDUCERS = new InjectionToken('@ngrx/store Feature Reducers');
...
const /** @type {?} */ UPDATE = /** @type {?} */ ('@ngrx/store/update-reducers');
...
const /** @type {?} */ REDUCER_MANAGER_PROVIDERS = [
    ReducerManager,
...
const /** @type {?} */ SCANNED_ACTIONS_SUBJECT_PROVIDERS = [
...
const /** @type {?} */ STORE_PROVIDERS = [Store];
/**
 * @template T, Props, K
 * @param {?} pathOrMapFn
 * @param {?} propsOrPath
